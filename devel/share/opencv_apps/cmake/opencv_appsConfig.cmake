...
if("TRUE" STREQUAL "TRUE")
  set(opencv_apps_SOURCE_PREFIX /home/cc/ee106a/fa15/class/ee106a-as/ros_ws/final_proj/src/vision_opencv/opencv_apps)
  set(opencv_apps_DEVEL_PREFIX /home/cc/ee106a/fa15/class/ee106a-as/ros_ws/final_proj/devel)
  ...
  set(opencv_apps_INSTALL_PREFIX /home/cc/ee106a/fa15/class/ee106a-as/ros_ws/final_proj/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'opencv_apps' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Kei Okada <kei.okada@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'opencv_apps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa15/class/ee106a-as/ros_ws/final_proj/src/vision_opencv/opencv_apps/${idir}'.  Ask the maintainer 'Kei Okada <kei.okada@gmail.com>' to fix it.")
    endif()
...
set(opencv_apps_EXPORTED_TARGETS "opencv_apps_gencfg;opencv_apps_generate_messages_cpp;opencv_apps_generate_messages_lisp;opencv_apps_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${opencv_apps_dep}_FOUND)
      find_package(${opencv_apps_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${opencv_apps_dep} REQUIRED ${depend_list})
  endif()
